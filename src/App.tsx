...
export function App() {
  return (
    <div className='w-screen h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100'>
      <div className='flex flex-col items-center justify-center border-2 border-cyan-500/40 w-[512px] h-[708px] shadow-lg shadow-cyan-500'>
        ...
        <form className='flex flex-col gap-4 items-stretch w-full max-w-[400px] mt-10 mx-14'>
